...
export class WasmEmulator {
     ...
     * @param {number} volume
     */
    constructor(freq_scale, volume) {
        const ret = wasm.wasmemulator_new(freq_scale, volume);
        this.__wbg_ptr = ret >>> 0;
        WasmEmulatorFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    static initLogger() {
        wasm.wasmemulator_initLogger();
    }
    /**
     * @param {EmulatorUpdateInput} arg0
     * @returns {EmulatorUpdateResult}
     */
    update(arg0) {
        const ret = wasm.wasmemulator_update(this.__wbg_ptr, addHeapObject(arg0));
        return takeObject(ret);
    }
    /**
     * @param {EmulatorStepInput} arg0
     * @returns {EmulatorUpdateResult}
     */
    step(arg0) {
        const ret = wasm.wasmemulator_step(this.__wbg_ptr, addHeapObject(arg0));
        return takeObject(ret);
    }
    /**
     * @param {Uint8Array} rom
     * @param {number} timestamp
     * @returns {LoadCartResult}
     */
    loadCart(rom, timestamp) {
        const ptr0 = passArray8ToWasm0(rom, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmemulator_loadCart(this.__wbg_ptr, ptr0, len0, timestamp);
        return takeObject(ret);
    }
    /**
    ...
    save() {
        try {
            ...
            wasm.wasmemulator_save(retptr, this.__wbg_ptr);
     ...
     */
    load(save) {
        const ptr0 = passArray8ToWasm0(save, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmemulator_load(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    reset() {
    ...
    /**
     * @param {OffscreenCanvasRenderingContext2D} canvas
     */
    setScreenCanvas(canvas) {
        wasm.wasmemulator_setScreenCanvas(this.__wbg_ptr, addHeapObject(canvas));
    }
    /**
     * @param {OffscreenCanvasRenderingContext2D} canvas
     */
    setTilesCanvas(canvas) {
        wasm.wasmemulator_setTilesCanvas(this.__wbg_ptr, addHeapObject(canvas));
    }
    /**
     * @param {number} volume
     */
    setVolume(volume) {
        wasm.wasmemulator_setVolume(this.__wbg_ptr, volume);
    }
    /**
     * @param {number} freq_scale
     */
    setFreqScale(freq_scale) {
        wasm.wasmemulator_setFreqScale(this.__wbg_ptr, freq_scale);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('emulator_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
